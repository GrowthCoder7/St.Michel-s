...
const activities = [
  ...
  },
  {
    id: 2,
    title: 'Robotics Team',
    image: 'https://images.pexels.com/photos/1181248/pexels-photo-1181248.jpeg?auto=compress&cs=tinysrgb&w=1600',
  ...
  },
  {
    ...
    description: 'Express creativity through various mediums and participate in art exhibitions.',
  },
];
    ...
    <div>
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-r from-primary-900 to-primary-800">
        ...
        <div className="container relative text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Extracurricular & Activities</h1>
