...
const testimonials: Testimonial[] = [
  {
    ...
    name: 'Emma Johnson',
    role: 'Parent',
    content: 'St. Michel\'s has provided my child with an exceptional educational experience. The dedicated teachers and challenging curriculum have fostered a love of learning that extends beyond the classroom.',
  ...
  },
  {
    ...
    content: 'My years at St. Michel\'s shaped me into the person I am today. The school\'s emphasis on both academic excellence and character development prepared me well for college and beyond.',
  ...
  },
  {
    ...
    content: 'I\'ve found a supportive community at St. Michel\'s that encourages me to pursue my passions. The teachers truly care about our success and provide personalized guidance to help us reach our goals.',
